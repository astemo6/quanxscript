...
# **确保 SSH（端口 2250）始终允许**
echo "Allowing SSH (port 2250) to prevent disconnection..."
SSH_PORT=2250
...
# **设置默认策略为 DROP（拒绝所有流量）**
echo "Setting default ip6tables policies to DROP (Input) and ACCEPT (Output)..."
...
# **允许多个端口的 TCP 和 UDP 流量**
PORTS="22,53,80,81,443,2096,2250,5555,5580:5600,5690,8080,8000:8100"
